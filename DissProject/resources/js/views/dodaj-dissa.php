<div class="add-note" ng-app="addDiss">
    ...
    <div ng-show="session.length == 0" class="alert alert-info" role="alert">Gdy dodajesz dissa będąc zajerestrowanym masz możliwość podlądu jego ocen i komentarzy. To tylko diwe z wielu przywilejów zajerestrowanych użytkowników. Jeśli chcesz dowiedzieć się więcej <b><a href="#" class="alert-link">kliknij.</a></b></div>

    <div ng-show="session.length == 0" class="alert alert-danger" role="alert">NIE MOŻESZ DODAWAĆ DISSÓW będąc niezaloogowanjdsndjns</div>

    <div ng-show="session.logged == 1" class="alert alert-info" role="alert">Po dodaniu dissa będziesz otrzymywał powiadomienia o nowych komentarzach i ocenach twojego dissa.Będą one widoczne w menu po kliknięciu przycisku profil.</a></b></div>
