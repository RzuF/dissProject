...
<body>
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
          	...
          	<a class="navbar-brand" href="index.html">dissProject</a>
        </div>
    
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="navbar-collapse-4">
          	<ul class="nav navbar-nav navbar-right">
            	<li><a href="#">Oczekuj¹ce</a></li>
            	<li><a href="#">Top</a></li>
            	<li><a href="#">Losuj</a></li>
            	<li><a href="#">Dodaj</a></li>
           		<li>
              		<!-- <a class="btn btn-default btn-outline btn-circle"  data-toggle="collapse" href="#nav-collapse4" aria-expanded="false" aria-controls="nav-collapse4">Zaloguj <i class=""></i> </a> -->
              		<a href="login.html" class="btn btn-default btn-outline btn-circle" >Zaloguj <i class="fa fa-fw fa-user"></i></a>
            	</li>
          	</ul>
